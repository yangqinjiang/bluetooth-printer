...
const TextEncoder = require('text-encoding-gbk/index').TextEncoder;

const PrintDataBuilder = function () {
 ...
 */
PrintDataBuilder.prototype.text = function (content) {
  if (content) {
 ...
 * @param  {string} content  文字内容
 */
PrintDataBuilder.prototype.print = function (content) {
  this.text(content);
 ...
 * @param  {string}  content  文字内容
 */
PrintDataBuilder.prototype.println = function (content = '') {
 ...
 */
PrintDataBuilder.prototype.setAlign = function (align) {
 ...
 */
PrintDataBuilder.prototype.setFont = function (family) {
 ...
 */
PrintDataBuilder.prototype.setSize = function (width, height) {
  if (2 >= width && 2 >= height) {
 ...
 * @param  {boolean} bold
 */
PrintDataBuilder.prototype.setBold = function (bold) {
 ...
 */
PrintDataBuilder.prototype.setUnderline = function (underline) {
 ...
 */
PrintDataBuilder.prototype.setLineSpacing = function (n) {
 ...
 * @param {number} n
 */
PrintDataBuilder.prototype.lineFeed = function (n = 1) {
 ...
 */
PrintDataBuilder.prototype.setColor = function (color) {
 ...
 */
PrintDataBuilder.prototype.beep = function (n, t) {
 ...
 * 清空任务
 */
PrintDataBuilder.prototype.clear = function () {
  this._queue = Array.from(commands.HARDWARE.HW_INIT);
  return this;
};
 ...
 * 返回ArrayBuffer
 */
PrintDataBuilder.prototype.buffer = function () {
  return new Uint8Array(this._queue).buffer;
};

module.exports = PrintDataBuilder;